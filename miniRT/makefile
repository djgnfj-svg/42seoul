...
#    Updated: 2021/03/27 14:51:47 by ysong            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME_BONUS):	$(LIBNAME) $(MLXNAME) $(OBJS_BONUS) $(MOBJS_BONUS)
			$(GCC) $(CFLAG) -I$(INCLUDE) -L$(MLXDIR) -g -lpthread -lmlx -framework OpenGL -framework AppKit -o $(NAME_BONUS) $(OBJS_BONUS) $(MOBJS_BONUS) $(LIBNAME) $(MLXNAME)
